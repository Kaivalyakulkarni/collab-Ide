...
export default function EditorPage({ params }: { params: Promise<{ projectId: string }> }) {
    ...
    const handleFileSelect = (file: FileNode) => {
        ...
        setOpenTabs(prev => {
            ...
            if (alreadyOpen) return prev  // already in tabs, just switch
            return [...prev, file]        // add new tab
        })
    }

    const handleTabClose = (fileId: string, e: React.MouseEvent) => {
        e.stopPropagation()  // prevent tab click from firing when clicking ×
    ...
    return (
    <div style={{ display: "flex", height: "100vh", background: "#0a0a0a", fontFamily: "var(--font-jetbrains-mono), monospace" }}>
        ...
        <div style={{ width: "44px", background: "#0d0d0d", borderRight: "1px solid #1a1a1a", display: "flex", flexDirection: "column", alignItems: "center", padding: "8px 0", gap: "2px", flexShrink: 0 }}>
            <div
                ...
                title="Explorer"
                style={{ width: "36px", height: "36px", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", borderRadius: "4px", borderLeft: `2px solid ${activePanel === "files" ? "#BDC3C7" : "transparent"}`, color: activePanel === "files" ? "#BDC3C7" : "#555", transition: "all 0.15s" }}
            >
            ...
            <div
                ...
                style={{ width: "36px", height: "36px", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", borderRadius: "4px", borderLeft: `2px solid ${activePanel === "git" ? "#BDC3C7" : "transparent"}`, color: activePanel === "git" ? "#BDC3C7" : "#555", transition: "all 0.15s" }}
            >
        ...
        <div style={{ width: "220px", background: "#111", borderRight: "1px solid #1a1a1a", display: "flex", flexDirection: "column", flexShrink: 0, overflow: "hidden" }}>
            ...
            <div style={{ flex: 1, overflow: "auto" }}>
                {activePanel === "files" ? (
                    <FileTree files={files} onFileSelect={handleFileSelect} selectedFile={activeTab?.name} />
                ) : (
                ...
                <div style={{ height: `${terminalHeight}px`, background: "#0d0d0d", borderTop: "1px solid #1a1a1a", display: "flex", flexDirection: "column", flexShrink: 0, overflow: "hidden" }}>
                    ...
                    <div style={{ height: "30px", borderBottom: "1px solid #1a1a1a", display: "flex", alignItems: "center", padding: "0 14px", gap: "16px", flexShrink: 0 }}>
                        ...
                        <span
                            ...
                            style={{ marginLeft: "auto", fontSize: "14px", color: "#555", cursor: "pointer", lineHeight: 1 }}
                        >×</span>
                    </div>
                    <div style={{ flex: 1, overflow: "hidden" }}>
                        <TerminalComponent
